...
begin
    ...
    # Load data
    df_n40rksg = CSV.read("../../data/sm/compared_with_uniform/n40rksg_seed1_tc.csv", DataFrame)
    df_n200d3 = CSV.read("../../data/sm/compared_with_uniform/n200d3_seed1_tc.csv", DataFrame)
